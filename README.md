# XMLMetadataBuilder Plugin para OJS 3.4

![PHP](https://img.shields.io/badge/PHP-%3E%3D8.0-8892BF?logo=php&logoColor=white)
![OJS](https://img.shields.io/badge/OJS-3.4-blue)
...
1. **Copiar Archivos:** 
   Copiar la carpeta del plugin en el directorio plugins/generic/ de la instalación de OJS utilizando el siguiente comando: `git clone https://github.com/sedici/OJS-JATS-Completer/tree/stable-3_4 XMLMetadataBuilder`
